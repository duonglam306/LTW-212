            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <h2 class="theme-color fw-bold mb-2 text-uppercase text-success">Create an account</h2>
                        ...
                        <form action="" method="post">
                            ...
                            <button class="theme-color-btn btn btn-warning btn-lg px-5 mt-3 " name="submitBtn" type="submit">Sign up</button>
                        </form>
                    </div>
                </div>
            </div>
