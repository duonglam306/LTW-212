        ...
        <div class="col-lg-9">
            ...
            <div class="pagination" style="float:right; margin-right: 15px; margin-bottom: 15px;">
                ...
                if ($current_page > 1 && $total_page > 1) {
                    if (isset($_GET['feature'])) echo '<li class="page-item"><a  class="page-link" href="table.php?page=' . ($current_page - 1) . '&feature=' . $_GET['feature'] . '">Prev</a><li>';
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    if ($i == $current_page) {
                        ...
                        if (isset($_GET['feature'])) echo '<li class="page-item"><a  class="page-link" href="table.php?page=' . $i . '&feature=' . $_GET['feature'] . '">' . $i . '</a></li>';
                ...
                if ($current_page < $total_page && $total_page > 1) {
                    if (isset($_GET['feature'])) echo '<li class="page-item"><a  class="page-link" href="table.php?page=' . ($current_page + 1) . '&feature=' . $_GET['feature'] . '">Next</a><li>';
...
<script>
    function filterLaptop(e) {
        ...
        else if (inputfeature == 'all' && inputPrice != 'all') window.location.href = 'table.php?price=' + inputPrice;
        else if (inputfeature != 'all' && inputPrice == 'all') window.location.href = 'table.php?feature=' + inputfeature;
        else window.location.href = 'table.php?feature=' + inputfeature + '&price=' + inputPrice;
    }
</script>