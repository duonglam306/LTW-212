...
const Register = () => {
    ...
    return (
        <div className="loginContainer">
            <div class="shadow-lg p-3 mb-5 bg-white rounded modal-login">
                <form>
                    ...
                    <div className="inputBlock">
                        <label className="labelForm">
                            <span className="star">*</span>Số điện thoại
                        </label>
                        <input
                            required
                            type="tel"
                    ...
                    <div className="inputBlock">
                        <label className="labelForm">
                            <span className="star">*</span>Họ và tên
                        </label>
                        <input
                            required
                            type="text"
                    ...
                    <div className="inputBlock">
                        <label className="labelForm">
                            <span className="star">*</span>Nhập lại mật khẩu
                        </label>
                        <input
                            required
                            type="password"
