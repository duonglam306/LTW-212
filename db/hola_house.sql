...
(55, 22, 9050000, 'Ho Chi Minh, Viet Nam', 'Paid', 'Sat Jun 11 2022 12:32:14 GMT+0700 (Indochina Time)'),
(56, 22, 7050000, 'Ho Chi Minh, Viet Nam', 'Paid', 'Sat Jun 11 2022 12:33:22 GMT+0700 (Indochina Time)'),
(57, 22, 7050000, 'Ho Chi Minh, Viet Nam', 'Paid', 'Sat Jun 11 2022 12:35:06 GMT+0700 (Indochina Time)'),
(58, 22, 9050000, 'Ho Chi Minh, Viet Nam', 'Paid', 'Sat Jun 11 2022 20:11:46 GMT+0700 (Indochina Time)'),
(59, 22, 9050000, 'Ho Chi Minh, Viet Nam', 'Paid', 'Sun Jun 12 2022 12:31:16 GMT+0700 (Indochina Time)');
...
(1, 'bk.furniture.hcmut@gmail.com', '268 Ly Thuong Kiet, Ward 14, District 10, Ho Chi Minh City, Vietnam', '0942826536', 'holahouse.com', 'img/contact.png', 1, '2022-06-11 12:33:46');
...
(1, 'Luxury Triangle Champ Side Table', 'Luxury Triangle Champ side table for living room', 9050000, 'img/side_table_luxury_triangle_champ.png', 'table', 'side table', 7),
(2, 'Charme Black Side Table', 'Charme Black side table for living room', 7050000, 'img/side_table_charme_black.png', 'table', 'side table', 7),
(3, 'Pio Side Table', 'Pio side table for livingroom', 3830000, 'img/side_table_pio.png', 'table', 'side table', 10),
(4, 'Flamingo Side Table', 'Flamingo side table for livingroom', 12870000, 'img/side_table_flamingo.png', 'table', 'side table', 10),
(5, 'Miami Dinner Table', 'Miami dinner table for dining room', 12900000, 'img/dinner_table_miami.png', 'table', 'dinner table', 10),
(6, 'Pio Dinner Table', 'Pio dinner table for dining room', 12670000, 'img/dinner_table_pio.png', 'table', 'dinner table', 10),
(7, 'Roma Dinner Table', 'Roma dinner table for dining room', 9720000, 'img/dinner_table_roma.png', 'table', 'dinner table', 10),
(8, 'Porto Dinner Table', 'Porto dinner table for dining room', 25430000, 'img/dinner_table_porto.png', 'table', 'dinner table', 10),
(9, 'Inox Makeup Table', 'Inox makeup table for bedroom', 13450000, 'img/makeup_table_inox.png', 'table', 'makeup table', 10),
(10, 'Rattan Makeup Table', 'Rattan makeup table for bedroom', 24450000, 'img/makeup_table_rattan.png', 'table', 'makeup table', 10),
(11, 'Skagen Makeup Table', 'Skagen makeup table for bedroom', 12700000, 'img/makeup_table_skagen.png', 'table', 'makeup table', 10),
(12, 'Maxine Desk', 'Maxine desk for work room', 51940000, 'img/desk_maxine.png', 'table', 'desk', 10),
(13, 'Osaka Desk', 'Osaka desk for work room', 22900000, 'img/desk_osaka.png', 'table', 'desk', 10),
(14, 'Pio Desk', 'Pio desk for work room', 13650000, 'img/desk_pio.png', 'table', 'desk', 10),
(15, 'Skagen Desk', 'Skagen desk for work room', 12670000, 'img/desk_skagen.png', 'table', 'desk', 10),
(16, 'Miami Bed 1m2', 'Miami Bed 1m2 for bedroom', 15290000, 'img/bed_1m2_miami.png', 'bed', 'bed 1m2', 10),
(17, 'Iris Bed 1m6', 'Iris bed 1m6 for bedroom', 14630000, 'img/bed_1m6_iris.png', 'bed', 'bed 1m6', 10),
(18, 'Penny Bed 1m6', 'Penny bed 1m6 for bedroom', 14630000, 'img/bed_1m6_penny.png', 'bed', 'bed 1m6', 10),
(19, 'Miami Bed 1m6', 'Miami bed 1m6 for bedroom', 17900000, 'img/bed_1m6_miami.png', 'bed', 'bed 1m6', 10),
(20, 'Dubai Bed 1m6', 'Dubai bed 1m6 for bedroom', 14900000, 'img/bed_1m6_dubai.png', 'bed', 'bed 1m6', 10),
(21, 'Iris Bed 1m8', 'Iris bed 1m8 for bedroom', 15610000, 'img/bed_1m8_iris.png', 'bed', 'bed 1m8', 10),
(22, 'Penny Bed 1m8', 'Penny bed 1m8 for bedroom', 15610000, 'img/bed_1m8_penny.png', 'bed', 'bed 1m8', 10),
(23, 'Miami Bed 1m8', 'Miami bed 1m8 for bedroom', 19900000, 'img/bed_1m8_miami.png', 'bed', 'bed 1m8', 10),
(24, 'Skagen Bed 1m8', 'Skagen bed 1m8 for bedroom', 24450000, 'img/bed_1m8_skagen.png', 'bed', 'bed 1m8', 10),
(25, 'Bench Atllo', 'Bench atllo for bedroom', 21590000, 'img/bench_atllo.png', 'chair', 'benches', 10),
(26, 'Bench Elegance', 'Bench elegance for bedroom', 26770000, 'img/bench_elegance.png', 'chair', 'benches', 10),
(27, 'Bench Miami', 'Bench miami for bedroom', 6200000, 'img/bench_miami.png', 'chair', 'benches', 10),
(28, 'Bench Bridge', 'Bench bridge for bedroom', 29590000, 'img/bench_bridge.png', 'chair', 'benches', 10),
(29, 'Albert Kuip Taupe Dining Chair ', 'Albert kuip taupe dining chair for dining room', 12300000, 'img/dining_chair_albert_kuip_taupe.png', 'chair', 'dining chairs', 10),
(30, 'Kissy Dining Chair', 'Kissy dining chair', 4500000, 'img/dining_chair_kissy.png', 'chair', 'dining chairs', 10),
(31, 'Rusty Dining Chair', 'Rusty dining chair', 12900000, 'img/dining_chair_rusty.png', 'chair', 'dining chairs', 10),
(32, 'Carmen Dining Chair', 'Carmen dining chair for dining room', 12240000, 'img/dining_chair_carmen.png', 'chair', 'dining chairs', 10),
(33, 'Royal Armchair', 'Royal armchair for living room', 11900000, 'img/armchair_royal.png', 'chair', 'armchair', 10),
(34, 'Tudor Velvet Armchair', 'Tudor velvet armchair for living room', 23700000, 'img/armchair_tudor_velvet.png', 'chair', 'armchair', 10),
(35, 'Garbo Armchair', 'Garbo armchair for living room', 12180000, 'img/armchair_garbo.png', 'chair', 'armchair', 10),
(36, 'Hailey Armchair', 'Hailey armchair for living room', 23390000, 'img/armchair_hailey.png', 'chair', 'armchair', 10),
(37, 'Lanora Work Chair', 'Lanora work chair for work room', 14200000, 'img/work_chair_lanora.png', 'chair', 'work chair', 10),
(38, 'Bossy Work Chair', 'Bossy work chair for work room', 34290000, 'img/work_chair_bossy.png', 'chair', 'work chair', 10),
(39, 'Franky Work Chair', 'Franky work chair for work room', 12800000, 'img/work_chair_franky.png', 'chair', 'work chair', 10),
(40, 'Pinn Work Chair', 'Pinn work chair for work room', 25700000, 'img/work_chair_pinn.png', 'chair', 'work chair', 10),
(41, 'Stone Ceiling Lamp', 'Stone ceiling lamp for decorate', 46350000, 'img/ceiling_lamp_stone.png', 'lamp', 'ceiling lamp', 10),
(42, 'Beam Brass Ceiling Lamp', 'Beam brass ceiling lamp for decorate', 22590000, 'img/ceiling_lamp_beam_brass.png', 'lamp', 'ceiling lamp', 10),
(43, 'Capello Ceiling Lamp', 'Capello ceiling lamp for decorate', 19540000, 'img/ceiling_lamp_capello.png', 'lamp', 'ceiling lamp', 10),
(44, 'Tori Ceiling Lamp', 'Tori ceiling lamp for decorate', 6900000, 'img/ceiling_lamp_tori.png', 'lamp', 'ceiling lamp', 10),
(45, 'Axe Floor Lamp', 'Axe floor lamp for decorate', 13650000, 'img/floor_lamp_axe.png', 'lamp', 'floor lamp', 10),
(46, 'Fjella Floor Lamp', 'Fjella floor lamp for decorate', 11900000, 'img/floor_lamp_fjella.png', 'lamp', 'floor lamp', 10),
(47, 'Vivana Floor Lamp', 'Vivana floor lamp for decorate', 7000000, 'img/floor_lamp_vivana.png', 'lamp', 'floor lamp', 10),
(48, 'Suzette Floor Lamp', 'Suzette floor lamp for decorate', 13260000, 'img/floor_lamp_suzette.png', 'lamp', 'floor lamp', 10),
(49, 'Charlie Standing Lamp', 'Charlie standing lamp for workspace', 6680000, 'img/standing_lamp_charlie.png', 'lamp', 'standing lamp', 10),
(50, 'Lamelod Standing Lamp', 'Lamelod standing lamp for living room', 2990000, 'img/standing_lamp_lamelod.png', 'lamp', 'standing lamp', 10),
(51, 'Thod Standing Lamp', 'Thod standing lamp for living room', 4950000, 'img/standing_lamp_thod.png', 'lamp', 'standing lamp', 10),
(52, 'Wipid Standing Lamp', 'Wipid standing lamp for living room', 6990000, 'img/standing_lamp_wipid.png', 'lamp', 'standing lamp', 10),
(53, 'Lombard Table Lamp', 'Lombard table lamp for bedroom', 17200000, 'img/table_lamp_lombard.png', 'lamp', 'table lamp', 10),
(54, 'Fotellina Ant Brass Table Lamp', 'Fotellina ant brass table lamp for workspace', 36600000, 'img/table_lamp_fotellina_ant_brass.png', 'lamp', 'table lamp', 10),
(55, 'Olympia Nickel Table Lamp', 'Olympia nickel table lamp for workspace', 19670000, 'img/table_lamp_olympia_nickel.png', 'lamp', 'table lamp', 10),
(56, 'Champ Table Lamp', 'Champ table lamp for workspace', 6600000, 'img/table_lamp_champ.png', 'lamp', 'table lamp', 10);
...
(22, 'lamduong123', '$2y$12$qVl2meoY3g1zEof0aIECP.FB.Q2RMTcyoHCdVEOLKdRUvA/R0yq66', 'Lâm Thành Dương', 'customer', 'lamduong11201@gmail.com', 'Ho Chi Minh, Viet Nam', '+84942826536', 'uploads/avatar8.png'),
(23, 'long', '$2y$12$9uKRz7/V4VYAw/k69lcVuuBkKeus..W3Hm/P5EgEpn3l07B.DkLS2', 'Long Mai', 'customer', 'maiduclong11102001@gmail.com', NULL, NULL, 'img/avatar.png'),
(28, 'duong', '$2y$12$BRqPsVad5jcCHXCSLb2fF.qNpPFWdggpaFEt4QlBOONQMVZrCp8Fm', 'Lâm Thành Dương', 'customer', 'duong.lamthanh3006@hcmut.edu.vn', NULL, NULL, 'img/avatar2.png');
