    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="row align-items-end">
                <div class="col-md-4 pb-4">
                    ...
                    <select class="form-select" id="filter-features">
                        ...
                        $sql = "SELECT * FROM category WHERE type = 'chair'";
            ...
            <div class="row">
                ...
                $query = null;
                if ($feature == null) {
                    $query = "SELECT COUNT(uid) as total from product where type='chair'";
                } else {
                    $query = "SELECT COUNT(uid) as total from product where type='chair' and category='$feature'";
                }
                ...
                if ($feature == null && $price == null) {
                    $query = "SELECT * FROM product WHERE type = 'chair' LIMIT $start, $limit";
                } elseif ($feature == null && $price != null) {
                    if ($price == 'low-to-high') {
                        $query = "SELECT * FROM product WHERE type = 'chair' ORDER BY price ASC LIMIT $start, $limit";
                    } else {
                        $query = "SELECT * FROM product WHERE type = 'chair' ORDER BY price DESC LIMIT $start, $limit";
                    }
                } elseif ($feature != null && $price == null) {
                    $query = "SELECT * FROM product WHERE type='chair' and category='$feature' LIMIT $start, $limit";
                } else {
                    if ($price == 'low-to-high') {
                        $query = "SELECT * FROM product WHERE type='chair' and category='$feature' ORDER BY price ASC LIMIT $start, $limit";
                    } else {
                        $query = "SELECT * FROM product WHERE type='chair' and category='$feature' ORDER BY price DESC LIMIT $start, $limit";
                    }
                }
                $result = mysqli_query($conn, $query);
                if (mysqli_num_rows($result) > 0) {
...
<script>
    function filterChair(e) {
        ...
        else if (inputfeature == 'all' && inputPrice != 'all') window.location.href = 'chair.php?price=' + inputPrice;
        else if (inputfeature != 'all' && inputPrice == 'all') window.location.href = 'chair.php?feature=' + inputfeature;
        else window.location.href = 'chair.php?feature=' + inputfeature + '&price=' + inputPrice;
    }
</script>