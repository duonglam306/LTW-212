...
<body>
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="theme-color navbar-brand text-success logo align-self-center" style="font-size: 30px !important" href="index.php">
                <i class="fa fa-chevron-left"></i>
                Back
            </a>

            <a class="theme-color navbar-brand text-success logo h1 align-self-center" href="index.php">
                Hola House
            </a>
        </div>
    </nav>
                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4">
                            ...
                            <h2 class="theme-color fw-bold mb-2 text-uppercase text-success">Login to Hola House Admin</h2>
                            ...
                            <form action="" method="post">
                                ...
                                <button class="theme-color-btn btn btn-warning btn-lg px-5 mt-4" type="submit" name="submitBtn">Login</button>
                            </form>
                        </div>

                        <div>
                            <p class="theme-color mb-0 text-success">Don't have an account? <a href="register.php" class="text-white-50 fw-bold">Sign Up</a></p>
                        </div>
